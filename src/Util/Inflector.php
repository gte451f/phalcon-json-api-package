...
class Inflector
{
    ...
    private $uncountableWords = array(
        'equipment',
        'information',
        'rice',
        'money',
    ...
    function pluralize($word)
    {
        $plural = array(
            ...
            '/(bu)s$/i' => '\1ses',
            '/(alias|status)/i' => '\1es',
            '/(octop|vir)us$/i' => '\1i', //hypercorrect (wrong) plurals, should be octopuses/viruses
            '/(ax|test)is$/i' => '\1es',
            '/s$/i' => 's',
            '/$/' => 's'
            //what about other -us like campus > campi?
        );
     ...
     *
     * Convert any "CamelCased" into an "underscored_word".
     *
     ...
     *            If set to 'all' it will uppercase all the words
